<?php
/**
 * File for class NPSoapStructPNGETDATAResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPNGETDATAResult originally named PNGETDATAResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPNGETDATAResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PNGETDATAResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPNGETDATAResult::setAny()
