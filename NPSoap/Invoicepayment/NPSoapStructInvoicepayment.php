<?php
/**
 * File for class NPSoapStructInvoicepayment
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructInvoicepayment originally named invoicepayment
 ...
 * @date 2013-09-16
 */
class NPSoapStructInvoicepayment extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for invoicepayment
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructInvoicepayment::setAny()
