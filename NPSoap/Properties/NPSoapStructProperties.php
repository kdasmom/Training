<?php
/**
 * File for class NPSoapStructProperties
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructProperties originally named properties
 ...
 * @date 2013-09-16
 */
class NPSoapStructProperties extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructProperties::setAny()
