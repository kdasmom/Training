<?php
/**
 * File for class NPSoapStructActuals
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructActuals originally named actuals
 ...
 * @date 2013-09-16
 */
class NPSoapStructActuals extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for actuals
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructActuals::setAny()
