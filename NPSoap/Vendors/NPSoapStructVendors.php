<?php
/**
 * File for class NPSoapStructVendors
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructVendors originally named vendors
 ...
 * @date 2013-09-16
 */
class NPSoapStructVendors extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for vendors
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructVendors::setAny()
