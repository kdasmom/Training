<?php
/**
 * File for class NPSoapStructInvoices
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructInvoices originally named invoices
 ...
 * @date 2013-09-16
 */
class NPSoapStructInvoices extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructInvoices::setAny()
