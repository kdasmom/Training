<?php
/**
 * File for class NPSoapStructInvoiceconfirmlist
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructInvoiceconfirmlist originally named invoiceconfirmlist
 ...
 * @date 2013-09-16
 */
class NPSoapStructInvoiceconfirmlist extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for invoiceconfirmlist
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructInvoiceconfirmlist::setAny()
