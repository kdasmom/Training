<?php
/**
 * File for class NPSoapStructGlaccount
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructGlaccount originally named glaccount
 ...
 * @date 2013-09-16
 */
class NPSoapStructGlaccount extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for glaccount
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructGlaccount::setAny()
