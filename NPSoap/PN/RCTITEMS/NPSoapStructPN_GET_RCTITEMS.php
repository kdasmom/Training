<?php
/**
 * File for class NPSoapStructPN_GET_RCTITEMS
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_RCTITEMS originally named PN_GET_RCTITEMS
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_RCTITEMS extends NPSoapWsdlClass
{
	/**
	...
	/**
	 * Constructor method for PN_GET_RCTITEMS
	 * @see parent::__construct()
	 * @param int $_integrationPackageId
	 * @return NPSoapStructPN_GET_RCTITEMS
	 */
