<?php
/**
 * File for class NPSoapStructPN_GET_DATA
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_DATA originally named PN_GET_DATA
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_DATA extends NPSoapWsdlClass
{
	/**
	...
	public $datatype;
	/**
	 * Constructor method for PN_GET_DATA
	 * @see parent::__construct()
	 * @param int $_integrationPackageId
	 * @param string $_datatype
	 * @return NPSoapStructPN_GET_DATA
	 */
	public function __construct($_integrationPackageId,$_datatype = NULL)
	{
		parent::__construct(array('IntegrationPackageId'=>$_integrationPackageId,'datatype'=>$_datatype));
	}
	/**
