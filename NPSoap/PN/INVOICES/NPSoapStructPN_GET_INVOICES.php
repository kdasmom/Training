<?php
/**
 * File for class NPSoapStructPN_GET_INVOICES
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_INVOICES originally named PN_GET_INVOICES
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_INVOICES extends NPSoapWsdlClass
{
	/**
	...
	/**
	 * Constructor method for PN_GET_INVOICES
	 * @see parent::__construct()
	 * @param int $_integrationPackageId
	 * @return NPSoapStructPN_GET_INVOICES
	 */
