<?php
/**
 * File for class NPSoapStructPN_SET_POITEMS_CONFIRM
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_POITEMS_CONFIRM originally named PN_SET_POITEMS_CONFIRM
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_POITEMS_CONFIRM extends NPSoapWsdlClass
{
	/**
	 * The integration_id
	 * Meta informations extracted from the WSDL
	...
	public $actuals;
	/**
	 * Constructor method for PN_SET_POITEMS_CONFIRM
	 * @see parent::__construct()
	 * @param int $_integration_id
	 * @param NPSoapStructActuals $_actuals
	 * @return NPSoapStructPN_SET_POITEMS_CONFIRM
	 */
