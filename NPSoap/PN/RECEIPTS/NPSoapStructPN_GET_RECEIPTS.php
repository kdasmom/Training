<?php
/**
 * File for class NPSoapStructPN_GET_RECEIPTS
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_RECEIPTS originally named PN_GET_RECEIPTS
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_RECEIPTS extends NPSoapWsdlClass
{
	/**
	...
	/**
	 * Constructor method for PN_GET_RECEIPTS
	 * @see parent::__construct()
	 * @param int $_integrationPackageId
	 * @return NPSoapStructPN_GET_RECEIPTS
	 */
