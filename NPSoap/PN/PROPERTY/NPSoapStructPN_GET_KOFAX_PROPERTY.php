<?php
/**
 * File for class NPSoapStructPN_GET_KOFAX_PROPERTY
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_KOFAX_PROPERTY originally named PN_GET_KOFAX_PROPERTY
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_KOFAX_PROPERTY extends NPSoapWsdlClass
{
	/**
	...
	/**
	 * Constructor method for PN_GET_KOFAX_PROPERTY
	 * @see parent::__construct()
	 * @param int $_integrationPackageId
	 * @return NPSoapStructPN_GET_KOFAX_PROPERTY
	 */
