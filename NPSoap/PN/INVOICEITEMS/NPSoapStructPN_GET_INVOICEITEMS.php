<?php
/**
 * File for class NPSoapStructPN_GET_INVOICEITEMS
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_INVOICEITEMS originally named PN_GET_INVOICEITEMS
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_INVOICEITEMS extends NPSoapWsdlClass
{
	/**
	...
	/**
	 * Constructor method for PN_GET_INVOICEITEMS
	 * @see parent::__construct()
	 * @param int $_integrationPackageId
	 * @return NPSoapStructPN_GET_INVOICEITEMS
	 */
