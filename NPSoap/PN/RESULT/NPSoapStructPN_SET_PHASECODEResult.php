<?php
/**
 * File for class NPSoapStructPN_SET_PHASECODEResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_PHASECODEResult originally named PN_SET_PHASECODEResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_PHASECODEResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_PHASECODEResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_PHASECODEResult::setAny()
