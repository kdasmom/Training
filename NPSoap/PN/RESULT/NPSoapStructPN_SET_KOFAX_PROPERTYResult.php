<?php
/**
 * File for class NPSoapStructPN_SET_KOFAX_PROPERTYResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_KOFAX_PROPERTYResult originally named PN_SET_KOFAX_PROPERTYResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_KOFAX_PROPERTYResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_KOFAX_PROPERTYResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_KOFAX_PROPERTYResult::setAny()
