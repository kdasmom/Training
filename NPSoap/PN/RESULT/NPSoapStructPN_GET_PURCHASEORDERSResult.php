<?php
/**
 * File for class NPSoapStructPN_GET_PURCHASEORDERSResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_PURCHASEORDERSResult originally named PN_GET_PURCHASEORDERSResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_PURCHASEORDERSResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_GET_PURCHASEORDERSResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_GET_PURCHASEORDERSResult::setAny()
