<?php
/**
 * File for class NPSoapStructPN_SAVE_QUERY_RESULTResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SAVE_QUERY_RESULTResult originally named PN_SAVE_QUERY_RESULTResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SAVE_QUERY_RESULTResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SAVE_QUERY_RESULTResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SAVE_QUERY_RESULTResult::setAny()
