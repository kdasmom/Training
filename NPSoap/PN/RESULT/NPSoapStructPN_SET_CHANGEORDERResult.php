<?php
/**
 * File for class NPSoapStructPN_SET_CHANGEORDERResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_CHANGEORDERResult originally named PN_SET_CHANGEORDERResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_CHANGEORDERResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_CHANGEORDERResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_CHANGEORDERResult::setAny()
