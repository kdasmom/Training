<?php
/**
 * File for class NPSoapStructPN_SET_ACTUALResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_ACTUALResult originally named PN_SET_ACTUALResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_ACTUALResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_ACTUALResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_ACTUALResult::setAny()
