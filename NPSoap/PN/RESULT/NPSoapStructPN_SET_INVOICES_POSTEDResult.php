<?php
/**
 * File for class NPSoapStructPN_SET_INVOICES_POSTEDResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_INVOICES_POSTEDResult originally named PN_SET_INVOICES_POSTEDResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_INVOICES_POSTEDResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_INVOICES_POSTEDResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_INVOICES_POSTEDResult::setAny()
