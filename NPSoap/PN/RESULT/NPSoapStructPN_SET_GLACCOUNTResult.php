<?php
/**
 * File for class NPSoapStructPN_SET_GLACCOUNTResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_GLACCOUNTResult originally named PN_SET_GLACCOUNTResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_GLACCOUNTResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_GLACCOUNTResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_GLACCOUNTResult::setAny()
