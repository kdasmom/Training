<?php
/**
 * File for class NPSoapStructPN_GET_INVOICEITEMSResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_INVOICEITEMSResult originally named PN_GET_INVOICEITEMSResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_INVOICEITEMSResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_GET_INVOICEITEMSResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_GET_INVOICEITEMSResult::setAny()
