<?php
/**
 * File for class NPSoapStructPN_SET_KOFAX_VENDORResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_KOFAX_VENDORResult originally named PN_SET_KOFAX_VENDORResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_KOFAX_VENDORResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_KOFAX_VENDORResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_KOFAX_VENDORResult::setAny()
