<?php
/**
 * File for class NPSoapStructPN_SET_DATAResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_DATAResult originally named PN_SET_DATAResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_DATAResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_DATAResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_DATAResult::setAny()
