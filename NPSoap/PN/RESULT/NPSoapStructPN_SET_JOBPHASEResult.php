<?php
/**
 * File for class NPSoapStructPN_SET_JOBPHASEResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_JOBPHASEResult originally named PN_SET_JOBPHASEResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_JOBPHASEResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_JOBPHASEResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_JOBPHASEResult::setAny()
