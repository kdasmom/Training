<?php
/**
 * File for class NPSoapStructPN_GET_KOFAX_VENDORSResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_KOFAX_VENDORSResult originally named PN_GET_KOFAX_VENDORSResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_KOFAX_VENDORSResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_GET_KOFAX_VENDORSResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_GET_KOFAX_VENDORSResult::setAny()
