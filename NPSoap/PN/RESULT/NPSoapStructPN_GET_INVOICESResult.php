<?php
/**
 * File for class NPSoapStructPN_GET_INVOICESResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_INVOICESResult originally named PN_GET_INVOICESResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_INVOICESResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_GET_INVOICESResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_GET_INVOICESResult::setAny()
