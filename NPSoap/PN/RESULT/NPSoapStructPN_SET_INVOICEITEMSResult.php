<?php
/**
 * File for class NPSoapStructPN_SET_INVOICEITEMSResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_INVOICEITEMSResult originally named PN_SET_INVOICEITEMSResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_INVOICEITEMSResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_INVOICEITEMSResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_INVOICEITEMSResult::setAny()
