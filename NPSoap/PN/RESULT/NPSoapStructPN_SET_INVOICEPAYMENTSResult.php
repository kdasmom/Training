<?php
/**
 * File for class NPSoapStructPN_SET_INVOICEPAYMENTSResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_INVOICEPAYMENTSResult originally named PN_SET_INVOICEPAYMENTSResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_INVOICEPAYMENTSResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_INVOICEPAYMENTSResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_INVOICEPAYMENTSResult::setAny()
