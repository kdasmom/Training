<?php
/**
 * File for class NPSoapStructPN_SET_ERRORCODESResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_ERRORCODESResult originally named PN_SET_ERRORCODESResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_ERRORCODESResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_ERRORCODESResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_ERRORCODESResult::setAny()
