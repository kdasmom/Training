<?php
/**
 * File for class NPSoapStructPN_SET_CONTRACTResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_CONTRACTResult originally named PN_SET_CONTRACTResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_CONTRACTResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_CONTRACTResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_CONTRACTResult::setAny()
