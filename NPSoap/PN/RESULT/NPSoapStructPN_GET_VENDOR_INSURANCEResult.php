<?php
/**
 * File for class NPSoapStructPN_GET_VENDOR_INSURANCEResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_VENDOR_INSURANCEResult originally named PN_GET_VENDOR_INSURANCEResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_VENDOR_INSURANCEResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_GET_VENDOR_INSURANCEResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_GET_VENDOR_INSURANCEResult::setAny()
