<?php
/**
 * File for class NPSoapStructPN_GET_INVOICES_CONFIRMResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_INVOICES_CONFIRMResult originally named PN_GET_INVOICES_CONFIRMResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_INVOICES_CONFIRMResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_GET_INVOICES_CONFIRMResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_GET_INVOICES_CONFIRMResult::setAny()
