<?php
/**
 * File for class NPSoapStructPN_SET_VENDORCOMBOResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_VENDORCOMBOResult originally named PN_SET_VENDORCOMBOResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_VENDORCOMBOResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_VENDORCOMBOResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_VENDORCOMBOResult::setAny()
