<?php
/**
 * File for class NPSoapStructPN_GET_DATAResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_DATAResult originally named PN_GET_DATAResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_DATAResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_GET_DATAResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_GET_DATAResult::setAny()
