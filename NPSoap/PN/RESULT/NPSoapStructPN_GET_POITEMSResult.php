<?php
/**
 * File for class NPSoapStructPN_GET_POITEMSResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_POITEMSResult originally named PN_GET_POITEMSResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_POITEMSResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_GET_POITEMSResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_GET_POITEMSResult::setAny()
