<?php
/**
 * File for class NPSoapStructPN_SET_INVOICESResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_INVOICESResult originally named PN_SET_INVOICESResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_INVOICESResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_INVOICESResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_INVOICESResult::setAny()
