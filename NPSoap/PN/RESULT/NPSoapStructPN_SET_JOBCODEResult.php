<?php
/**
 * File for class NPSoapStructPN_SET_JOBCODEResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_JOBCODEResult originally named PN_SET_JOBCODEResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_JOBCODEResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_JOBCODEResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_JOBCODEResult::setAny()
