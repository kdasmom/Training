<?php
/**
 * File for class NPSoapStructPN_GET_RECEIPTSResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_RECEIPTSResult originally named PN_GET_RECEIPTSResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_RECEIPTSResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_GET_RECEIPTSResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_GET_RECEIPTSResult::setAny()
