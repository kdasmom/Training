<?php
/**
 * File for class NPSoapStructPN_GET_RCTITEMSResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_RCTITEMSResult originally named PN_GET_RCTITEMSResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_RCTITEMSResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_GET_RCTITEMSResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_GET_RCTITEMSResult::setAny()
