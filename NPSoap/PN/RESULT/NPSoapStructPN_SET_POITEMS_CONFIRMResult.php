<?php
/**
 * File for class NPSoapStructPN_SET_POITEMS_CONFIRMResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_POITEMS_CONFIRMResult originally named PN_SET_POITEMS_CONFIRMResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_POITEMS_CONFIRMResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_POITEMS_CONFIRMResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_POITEMS_CONFIRMResult::setAny()
