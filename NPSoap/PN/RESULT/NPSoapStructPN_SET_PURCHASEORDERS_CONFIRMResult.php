<?php
/**
 * File for class NPSoapStructPN_SET_PURCHASEORDERS_CONFIRMResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_PURCHASEORDERS_CONFIRMResult originally named PN_SET_PURCHASEORDERS_CONFIRMResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_PURCHASEORDERS_CONFIRMResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_PURCHASEORDERS_CONFIRMResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_PURCHASEORDERS_CONFIRMResult::setAny()
