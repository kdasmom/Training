<?php
/**
 * File for class NPSoapStructPN_GET_VENDORCOMBO_CONFIRMResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_VENDORCOMBO_CONFIRMResult originally named PN_GET_VENDORCOMBO_CONFIRMResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_VENDORCOMBO_CONFIRMResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_GET_VENDORCOMBO_CONFIRMResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_GET_VENDORCOMBO_CONFIRMResult::setAny()
