<?php
/**
 * File for class NPSoapStructPN_SET_COSTCODEResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_COSTCODEResult originally named PN_SET_COSTCODEResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_COSTCODEResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_COSTCODEResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_COSTCODEResult::setAny()
