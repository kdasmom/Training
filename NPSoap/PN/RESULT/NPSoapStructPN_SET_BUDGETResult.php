<?php
/**
 * File for class NPSoapStructPN_SET_BUDGETResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_BUDGETResult originally named PN_SET_BUDGETResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_BUDGETResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for PN_SET_BUDGETResult
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructPN_SET_BUDGETResult::setAny()
