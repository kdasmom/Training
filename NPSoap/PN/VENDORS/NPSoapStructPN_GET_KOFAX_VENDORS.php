<?php
/**
 * File for class NPSoapStructPN_GET_KOFAX_VENDORS
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_KOFAX_VENDORS originally named PN_GET_KOFAX_VENDORS
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_KOFAX_VENDORS extends NPSoapWsdlClass
{
	/**
	...
	/**
	 * Constructor method for PN_GET_KOFAX_VENDORS
	 * @see parent::__construct()
	 * @param int $_integrationPackageId
	 * @return NPSoapStructPN_GET_KOFAX_VENDORS
	 */
