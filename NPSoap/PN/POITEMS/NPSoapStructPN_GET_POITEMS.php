<?php
/**
 * File for class NPSoapStructPN_GET_POITEMS
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_POITEMS originally named PN_GET_POITEMS
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_POITEMS extends NPSoapWsdlClass
{
	/**
	...
	/**
	 * Constructor method for PN_GET_POITEMS
	 * @see parent::__construct()
	 * @param int $_integrationPackageId
	 * @return NPSoapStructPN_GET_POITEMS
	 */
