<?php
/**
 * File for class NPSoapStructPN_SET_JOBCODE
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_SET_JOBCODE originally named PN_SET_JOBCODE
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_SET_JOBCODE extends NPSoapWsdlClass
{
	/**
	 * The integration_id
	 * Meta informations extracted from the WSDL
	...
	public $jobcodes;
	/**
	 * Constructor method for PN_SET_JOBCODE
	 * @see parent::__construct()
	 * @param int $_integration_id
	 * @param NPSoapStructJobcodes $_jobcodes
	 * @return NPSoapStructPN_SET_JOBCODE
	 */
