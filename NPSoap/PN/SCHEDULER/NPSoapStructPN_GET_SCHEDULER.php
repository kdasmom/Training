<?php
/**
 * File for class NPSoapStructPN_GET_SCHEDULER
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructPN_GET_SCHEDULER originally named PN_GET_SCHEDULER
 ...
 * @date 2013-09-16
 */
class NPSoapStructPN_GET_SCHEDULER extends NPSoapWsdlClass
{
	/**
	...
	/**
	 * Constructor method for PN_GET_SCHEDULER
	 * @see parent::__construct()
	 * @param int $_integrationPackageId
	 * @return NPSoapStructPN_GET_SCHEDULER
	 */
