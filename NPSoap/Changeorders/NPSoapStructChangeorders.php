<?php
/**
 * File for class NPSoapStructChangeorders
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructChangeorders originally named changeorders
 ...
 * @date 2013-09-16
 */
class NPSoapStructChangeorders extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for changeorders
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructChangeorders::setAny()
