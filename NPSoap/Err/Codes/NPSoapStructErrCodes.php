<?php
/**
 * File for class NPSoapStructErrCodes
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructErrCodes originally named ErrCodes
 ...
 * @date 2013-09-16
 */
class NPSoapStructErrCodes extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for ErrCodes
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructErrCodes::setAny()
