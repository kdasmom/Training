<?php
/**
 * File for class NPSoapStructVendorcombo
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructVendorcombo originally named vendorcombo
 ...
 * @date 2013-09-16
 */
class NPSoapStructVendorcombo extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for vendorcombo
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructVendorcombo::setAny()
