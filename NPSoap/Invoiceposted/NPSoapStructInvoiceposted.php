<?php
/**
 * File for class NPSoapStructInvoiceposted
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructInvoiceposted originally named invoiceposted
 ...
 * @date 2013-09-16
 */
class NPSoapStructInvoiceposted extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for invoiceposted
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructInvoiceposted::setAny()
