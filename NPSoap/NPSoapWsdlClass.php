...
class NPSoapWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses NPSoapWsdlClass::setLastError()
	 * @uses NPSoapWsdlClass::initSoapClient()
	 * @uses NPSoapWsdlClass::initInternArrayToIterate()
	 * @uses NPSoapWsdlClass::_set()
	...
	public static function __set_state(array $_array,$_className = __CLASS__)
	{
		if(class_exists($_className))
		{
			...
			if(is_object($object) && is_subclass_of($object,'NPSoapWsdlClass'))
			{
	 ...
	 * @uses NPSoapClassMap::classMap()
	 * @uses NPSoapWsdlClass::getDefaultWsdlOptions()
	 * @uses NPSoapWsdlClass::setSoapClient()
	 * @param array $_wsdlOptions WSDL options
	 * @return void
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('NPSoapClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = NPSoapClassMap::classMap();
	 ...
	 * @uses NPSoapWsdlClass::WSDL_CACHE_WSDL
	 * @uses NPSoapWsdlClass::WSDL_COMPRESSION
	 * @uses NPSoapWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses NPSoapWsdlClass::WSDL_ENCODING
	 * @uses NPSoapWsdlClass::WSDL_EXCPTS
	 * @uses NPSoapWsdlClass::WSDL_FEATURES
	 * @uses NPSoapWsdlClass::WSDL_LOGIN
	 * @uses NPSoapWsdlClass::WSDL_PASSWD
	 * @uses NPSoapWsdlClass::WSDL_SOAP_VERSION
	 * @uses NPSoapWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses NPSoapWsdlClass::WSDL_TRACE
	 * @uses NPSoapWsdlClass::WSDL_TYPEMAP
	 * @uses NPSoapWsdlClass::WSDL_URL
	 * @uses NPSoapWsdlClass::WSDL_USER_AGENT
	 ...
	 * @uses NPSoapWsdlClass::getSoapClient()
	 * @uses NPSoapWsdlClass::getFormatedXml()
	 ...
	 * @uses NPSoapWsdlClass::getSoapClient()
	 * @uses NPSoapWsdlClass::convertStringHeadersToArray()
	 ...
	 * @uses NPSoapWsdlClass::getInternArrayToIterate()
	 * @uses NPSoapWsdlClass::getInternArrayToIterateIsArray()
	 * @return int
	 */
	 ...
	 * @uses NPSoapWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses NPSoapWsdlClass::getInternArrayToIterateOffset()
	 * @uses NPSoapWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses NPSoapWsdlClass::getInternArrayToIterateOffset()
	 * @uses NPSoapWsdlClass::offsetExists()
	 * @return bool true|false
	 */
	 ...
	 * @uses NPSoapWsdlClass::getAttributeName()
	 * @uses NPSoapWsdlClass::__toString()
	 * @uses NPSoapWsdlClass::_set()
	 * @uses NPSoapWsdlClass::_get()
	 * @uses NPSoapWsdlClass::setInternArrayToIterate()
	 * @uses NPSoapWsdlClass::setInternArrayToIterateIsArray()
	 * @uses NPSoapWsdlClass::setInternArrayToIterateOffset()
