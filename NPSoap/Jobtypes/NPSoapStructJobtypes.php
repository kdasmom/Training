<?php
/**
 * File for class NPSoapStructJobtypes
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructJobtypes originally named jobtypes
 ...
 * @date 2013-09-16
 */
class NPSoapStructJobtypes extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for jobtypes
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructJobtypes::setAny()
