<?php
/**
 * File for class NPSoapStructInvoiceitems
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructInvoiceitems originally named invoiceitems
 ...
 * @date 2013-09-16
 */
class NPSoapStructInvoiceitems extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructInvoiceitems::setAny()
