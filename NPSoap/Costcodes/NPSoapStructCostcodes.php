<?php
/**
 * File for class NPSoapStructCostcodes
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructCostcodes originally named costcodes
 ...
 * @date 2013-09-16
 */
class NPSoapStructCostcodes extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for costcodes
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructCostcodes::setAny()
