<?php
/**
 * File for class NPSoapStructJobphases
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructJobphases originally named jobphases
 ...
 * @date 2013-09-16
 */
class NPSoapStructJobphases extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for jobphases
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructJobphases::setAny()
