<?php
/**
 * File for class NPSoapStructVendorconfirmlist
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructVendorconfirmlist originally named vendorconfirmlist
 ...
 * @date 2013-09-16
 */
class NPSoapStructVendorconfirmlist extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for vendorconfirmlist
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructVendorconfirmlist::setAny()
