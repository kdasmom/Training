<?php
/**
 * File for class NPSoapStructContractbudgets
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructContractbudgets originally named contractbudgets
 ...
 * @date 2013-09-16
 */
class NPSoapStructContractbudgets extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	...
	public $any;
	/**
	 * Constructor method for contractbudgets
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructContractbudgets::setAny()
