<?php
/**
 * File for class NPSoapStructXQuery
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructXQuery originally named xQuery
 ...
 * @date 2013-09-16
 */
class NPSoapStructXQuery extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructXQuery::setAny()
