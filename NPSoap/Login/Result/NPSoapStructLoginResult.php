<?php
/**
 * File for class NPSoapStructLoginResult
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructLoginResult originally named LoginResult
 ...
 * @date 2013-09-16
 */
class NPSoapStructLoginResult extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructLoginResult::setAny()
