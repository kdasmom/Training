<?php
/**
 * File for class NPSoapStructContracts
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructContracts originally named contracts
 ...
 * @date 2013-09-16
 */
class NPSoapStructContracts extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructContracts::setAny()
