<?php
/**
 * File for class NPSoapStructParameters
 * @package NPSoap
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NPSoapStructParameters originally named parameters
 ...
 * @date 2013-09-16
 */
class NPSoapStructParameters extends NPSoapWsdlClass
{
	/**
	 * The any
	 * @var DOMDocument
	 ...
	 * @uses DOMNode::item()
	 * @uses NPSoapStructParameters::setAny()
