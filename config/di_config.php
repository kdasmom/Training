...
$diDefinition = array(
	...
	'NP\system\ConfigService'                        => array('Config','SecurityService','SiteService','IntegrationPackageGateway', 'ConfigsysGateway', 'ConfigSysValGateway', 'PNUniversalFieldGateway'),
