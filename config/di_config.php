...
$diDefinition = array(
	...
	'NP\notification\NotificationService'      => array('EmailAlertTypeGateway','EmailAlertGateway','EmailAlertHourGateway','UserprofileGateway','Emailer'),
	...
	'NP\security\SecurityService'              => array('SessionService','UserprofileGateway','RoleGateway','UserprofileLogonGateway','ModulePrivGateway','RegionGateway','PropertyGateway','ConfigService','ModuleGateway'),
