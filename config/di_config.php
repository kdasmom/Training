...
$diDefinition = array(
	...
	'NP\property\PropertyService'              => array('SecurityService','PropertyGateway','RegionGateway','FiscalcalGateway','PropertyUserprofileGateway','UnitGateway','UserprofileGateway','InvoiceService','PoService','WfRuleTargetGateway','FiscalDisplayTypeGateway','FiscalcalMonthGateway'),
	...
	'NP\system\ConfigService'                  => array('config','WinCache','SiteService','ConfigsysGateway','PNUniversalFieldGateway','IntegrationRequirementsGateway','IntegrationPackageGateway','LookupcodeGateway','reloadCache'),
