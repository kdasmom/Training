Ext.define('NP.model.GLAccount', {
	...
	fields: [
		...
		{ name: 'glaccount_fullname', type: 'string', convert: function(val, rec) { return NP.model.GLAccount.getFormattedName(rec.get('glaccount_number'), rec.get('glaccount_name')); } }
	],
