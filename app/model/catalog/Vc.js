...
Ext.define('NP.model.catalog.Vc', {
	...
	fields: [
		...
		{ name: 'vc_vendorname' },
		{ name: 'vc_catalogname' },
		{ name: 'vc_createdt', type: 'date', dateFormat: NP.lib.core.Config.getServerDateFormat() },
		{ name: 'vc_createdby', type: 'int', defaultValue: NP.lib.core.Security.getDelegatedToUser().get('userprofile_id') },
		{ name: 'vc_lastupdatedt', type: 'date', dateFormat: NP.lib.core.Config.getServerDateFormat() },
		{ name: 'vc_lastupdateby', type: 'int', defaultValue: NP.lib.core.Security.getDelegatedToUser().get('userprofile_id') },
