...
Ext.define('NP.model.po.Purchaseorder', {
	...
	fields: [
		...
		{ name: 'purchaseorder_datetm', type: 'date', dateFormat: NP.Config.getServerDateFormat() },
		{ name: 'purchaseorder_created', type: 'date', dateFormat: NP.Config.getServerDateFormat() },
		{ name: 'property_id', type: 'int' },
		{ name: 'purchaseorder_note' },
		{ name: 'purchaseorder_closeddatetm', type: 'date', dateFormat: NP.Config.getServerDateFormat() },
		{ name: 'project_id' },
		{ name: 'task_id' },
		{ name: 'purchaseorder_reject_note' },
		{ name: 'purchaseorder_period', type: 'date', dateFormat: NP.Config.getServerDateFormat() },
		...
		{ name: 'purchaseorder_NeededBy_datetm', type: 'date', dateFormat: NP.Config.getServerDateFormat() },
		...
		{ name: 'purchaseorder_rct_canReceive_dt', type: 'date', dateFormat: NP.Config.getServerDateFormat() },
