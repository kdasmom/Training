 ...
 * 
 */
Ext.define('NP.lib.print.renderer.GridPanel', {
    ...
    generateBody: function(grid) {  
        ...
        var body     = this.generateGridBody( grid, columns, feature );
        ...
        return Ext.create('Ext.XTemplate', htmlMarkup).apply(records);
    },
    ...
    generateGridBody : function( grid, columns, feature ) 
    {
