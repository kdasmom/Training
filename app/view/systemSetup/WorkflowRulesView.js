    ...
    initComponent: function() {
        ...
        this.items = [
            // Row 1 - Header
            {
                ...
                html: 'Workflow Rule - ' + this.data.rule.wfrule_name
            },
            // Row 2 - Type
            {
                xtype: 'panel',
...
//TODO: Цикл по rule hours и трехколоночная таблица с часами
            ...
            switch (supression) {
                case 0:
                    supression = 'Never Suppress Email';
                    break;
                case 1:
                    supression = 'Suppress Email for the rest of the period';
                    break;
                default:
                    supression = 'Suppress Email for ' + supression + ' hours';
            }
            details.push({
                xtype: 'panel',
                items: [
