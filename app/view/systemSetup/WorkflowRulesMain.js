                ...
                items: [
					{
						...
						tbar: [
							...
							{ xtype: 'shared.button.copy', itemId: 'buttonWorkflowCopyRule' },
							{ xtype: 'shared.button.delete', itemId: 'buttonWorkflowDeleteRule' },
					...
					},
                    {
                        ...
                        html:[
							...
							'<ul>',
							'<li>	<strong>Budget amount (by GL category)</strong> - applies to both invoices and purchase orders; route the invoice or PO if it puts the selected GL category over budget by the specified amount.',
							'<li>	<strong>Budget amount (by GL code)</strong> - applies to both invoices and purchase orders; route the invoice or PO if it puts the selected GL code over budget by the specified amount.',
							'<li>	<strong>Invoice item amount (by GL category)</strong> - route an invoice if more than the specified amount is charged to the selected GL category.',
							'<li>	<strong>Invoice item amount (by GL code)</strong> - route an invoice if more than the specified amount is charged to the selected GL account.',
							'<li>	<strong>Invoice total amount</strong> - route an invoice if the total amount of the invoice exceeds the specified amount.',
							'<li>	<strong>Purchase Order item total (by GL category) </strong>- route a purchase order if more than the specified amount is charged to the selected GL category.',
							'<li>	<strong>Purchase Order item total (by GL code)</strong> - route a purchase order if more than the specified amount is charged to the selected GL code.',
							'<li>	<strong>Purchase Order total amount</strong> - route a purchase order if the total amount of the purchase order exceeds the specified amount.',
							'<li>	<strong>Specific vendor</strong> - applies to both invoices and purchase orders; route the invoice or purchase order according to the specified vendor and the total amount exceeds the specified amount.',
							'<li>	<strong>Specific vendor master </strong>- works like the specific vendor workflow rule except that purchase orders or invoices applied to the vendor designated in this rule do not route based on any other rule in the system except for this rule type.',
							'<li>	<strong>Yearly Budget amount (by GL Category)</strong>-applies to both invoices and purchase orders; routes the invoice or purchase order if it puts the selected GL category over the specified amount.',
							'<li>	<strong>Yearly Budget amount (by GL Code)</strong>- applies to both invoices and purchase orders; routes the invoice or purchase order if it puts the selected GL code over the specified amount.',
							'<li>	<strong>Converted Invoices - Master (by total amount)</strong> - applies only to invoices converted from a purchase order; routes the invoice according to the total dollar amount designated in this rule and does not route the invoice based on any other rule type  in the system.',
							'<li> <strong>Invoice Item Amount (by Job Code)</strong> - this rule will route the invoice for approval based on the job code assigned to any one invoice line item.',
							'<li> <strong>PO Item Amount (by Job Code)</strong> - this rule will route the purchase order for approval based on the job code assigned to any one purchase order line item.',
							'<li> <strong>Receipt Total Amount</strong> - this rule will route a receipt for approval based on the total receipt amount.',
							'<li> <strong>Invoice Item Amount (by Contract)</strong> - this rule will route the invoice for approval based on the contract assigned to any one invoice line item.',
							'<li> <strong>PO Item Amount (by Contract)</strong> - this rule will route the purchase order for approval based on the contract assigned to any one purchase order line item.',
							'<li> <strong>Invoice Item Amount (by Contract) - Master</strong>  - this rule will route the invoice for approval based on the contract assigned to any one invoice line item and override any other rules (except the Vendor Master rule).  If this rule applies, no other workflow rules (except the Vendor Master) will apply.',
							...
							'<li>	<strong>Invoice Total by Pay By-Master Rule</strong> -This rule will route invoices based on the header summary information and values entered into the pay by field on invoices.',
							...
							'<li> <strong>PO Item Amount by Department</strong> - route a purchase order if more than the specified amount is charged to the selected department.',
							'<li>	<strong>Invoice item amount by department</strong> - route an invoice if more than the specified amount is charged to the selected department.',
							'<li>	<strong>Receipt item total (by GL category) </strong>- route a receipt if more than the specified amount is charged to the selected GL category.',
							'<li>	<strong>Receipt item total (by GL code)</strong> - route a receipt if more than the specified amount is charged to the selected GL code.',
							'</ul>',
