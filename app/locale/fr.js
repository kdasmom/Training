...
Ext.define('NP.Locale', {
	 ...
	 */
	 ...
	 // Vendor Catalog Menu
	'Vendor Catalog'         : 'Catalogue de Fournisseurs',
	'Vendor Catalog Listings': 'Liste de Fournisseurs',
	'Open Orders'            : 'Commandes Ouvertes',
	'Favorite Items'         : 'Articles Favoris',

	// PO Menu
	'Purchase Orders'      : 'Bons de Commande',
	'PO Register'          : 'Registre de Bons de Commande',
	'Open'                 : 'Ouvert',
	'Template'             : 'Modèle',
	...
	'Rejected'             : 'Refusé',
	'Cancelled'            : 'Annulé',
	'Receipt Register'     : 'Registre de Reçus',
	'Pending Approval'     : 'En Attente d\'Approvation',
	'Pending Post Approval': 'En Attente d\'Approvation Secondaire',
	'New PO'               : 'Nouveau Bon de Commande',
	'Search POs'           : 'Recherche de Bons de Commande',

	// Invoice Menu
	'Invoices'             : 'Factures',
	'Invoice Register'     : 'Registre de Factures',
	'Overdue'              : 'En Retard',
	'On Hold'              : 'En Suspens',
	'Submitted for Payment': 'Soumis à Paiement',
	'Transferred to GL'    : 'Transferred to GL',
	'Paid'                 : 'Payé',
	'Void'                 : 'Annulé',
	'New Invoice'          : 'Nouvelle Facture',
	'Search Invoices'      : 'Recherche de Factures',

	// Vendor Menu
	'Vendors'            : 'Fournisseurs',
	'New Vendor'         : 'Nouveau Fournisseur',
	'Search Vendors'     : 'Recherche de Fournisseur',
	'VendorConnect Users': 'Usagers de VendorConnect',

	// Image Menu
	'Image Management'     : 'Gestion d\'Images',
	'Images To Be Indexed' : 'Images à Indexer',
	'Invoice Images'       : 'Images de Factures',
	'Purchase Order Images': 'Images de Bons de Commande',
	'Search Images'        : 'Recherche d\'Images',
	'Exceptions'           : 'Exceptions',

	// Budget Menu
	'Budget'       : 'Budget',
	'At-a-Glance'  : 'Aperçu',
	'Budget Search': 'Recherche de Budget',

	// Report Menu
	'Reports'                 : 'Rapports',
	'Custom Reports'          : 'Rapports Personnalisés',
	'Overview'                : 'Aperçu',
	'System Saved Reports'    : 'Rapports de Système',
	'My Saved Reports'        : 'Mes Rapports',
	'PO Register Reports'     : 'Rapports de Bons de Commande',
	'Receipt Reports'         : 'Rapports de Reçus',
	'Invoice Register Reports': 'Rapports de Factures',
	'Job Costing Reports'     : 'Rapports de Coût de Revient',
	'Utility Reports'         : 'Rapports de Services Public',
	'Vendor History Reports'  : 'Rapports d\'Historique de Fournisseurs',
	'Admin Reports'           : 'Rapports Administratifs',

	// Admin Menu
	'Administration'             : 'Administration',
	'My Settings'                : 'Mes Paramêtres',
	'User Manager'               : 'Gestion d\'Usagers',
	'Message Center'             : 'Centre de Messages',
	'Integration'                : 'Intégration',
	'{property} Setup'           : 'Configuration de {property}',
	'System Setup'               : 'Configuration de Système',
	'GL Account Setup'           : 'Configuration de Compte GL',
	'Catalog Maintenance'        : 'Configuration de Catalogue',
	'Import/Export Utility'      : 'Outil d\'Importation/Exportation',
	'GL'                         : 'GL',
	'Vendor'                     : 'Fournisseur',
	'Invoice'                    : 'Facture',
	'User'                       : 'Usager',
	...
	'Splits'                     : 'Divisions',
	'Set Approval Budget Overage': 'Rêglage d\'Approbation d\'Excédent de Budget',
	'Utility Setup'              : 'Configuration de Services Publics',
	'Mobile Setup'               : 'Configuration de Portables',
	...
	'This page already exists in Favorites'	: 'Cette page existe déjà dans les Favoris',

	/**
	 * DELEGATION PICKER
	 */
	'You are signed on as': 'Vous êtes connecté comme',

	/**
	 * CONTEXT PICKER
	 */
	'Current {property}': '{property} Courante',
	'All {properties}'  : 'Toutes les {properties}',
	...
	'Delete'              : 'Supprimer',
	'Edit'                : 'Modifier',
	'Place On Hold'       : 'Mettre En Suspens',
	...
	'Save'                : 'Sauvegarder',
	'Save And Add Another': 'Sauvegarder Et Ajouter',
	'Upload'              : 'Télécharger',
	'View'                : 'Visualiser',
	...
	// Home
	'Summary Statistics': 'Statistiques Sommaires',

	// Summary Stat Names
	'Purchase Orders To Approve'          : 'Bons de Commande à Approuver',
	'Approved Purchase Orders for Review' : 'Bons de Commande Approuvés à Réviser',
	'My Purchase Orders'                  : 'Mes Bons de Commande',
	'Rejected Purchase Orders'            : 'Bons de Commande Refusés',
	'Receipts To Approve'                 : 'Reçus à Approuver',
	'Rejected Receipts'                   : 'Reçus Refusés',
	'Receipts Pending Post Approval'      : 'Reçus En Attente d\'Approvation Secondaire',
	'Invoices to Approve'                 : 'Factures à Approuver',
	'Invoices on Hold'                    : 'Factures en Suspens',
	'Completed Invoices to Approve'       : 'Factures Complétées à Approuver',
	'Rejected Invoices'                   : 'Factures Refusées',
	'My Invoices'                         : 'Mes Factures',
	'Images to Convert to Invoice'        : 'Images à Convertir en Facture',
	'Image Invoices to be Processed'      : 'Images de Factures à Traiter',
	'Image Exceptions'                    : 'Exceptions d\'Images',
	'Images to be Indexed'                : 'Images à Indexer',
	'Vendors to Approve'                  : 'Fournisseurs à Approuver',
	'VendorConnect Authorization Request' : 'Demande d\'Autorisation VendorConnect',
	'Expired Insurance Certificates'      : 'Certificats d\'Assurance Expirés',
	'Month-to-Date Over Budget Categories': 'Cumul Mensuel des Catégories Excédant le Budget',
	'Year-to-Date Over Budget Categories' : 'Cumul Annuel des Catégories Excédant le Budget',

	/**
	 * TILES
	 */
	'GL Category MTD Spend'  : 'Cumul Mensuel de Dépense par Catégorie GL',
	'Invoice Statistics'     : 'Statistiques de Factures',
	'YTD Top Spend by Vendor': 'Cumul Annuel de Dépenses par Fournisseur',

	'Budget and Actual': 'Budget et Dépenses',
	'GL Category'      : 'Catégorie GL',
	'Actual'           : 'Dépenses',

	'Stat'             : 'Statistique',
	'Items'            : 'Éléments',

	'# of Images to Convert'            : '# d\'Images à Convertir',
	'# of Open Invoices'                : '# de Factures Ouvertes',
	'# of Invoices Pending Approval'    : '# de Factures en Attente d\'Approbation',
	'# of Completed Invoices to Approve': '# de Factures Complétées à Approuver',
	'# of Invoices on Hold'             : '# de Factures en Suspens',
	'# of Rejected Invoices'            : '# de Factures Refusées',
	...
	'Amount'                : 'Montant',
	'Date'                  : 'Date',
	'Number of Days On Hold': 'Nombre de Jours en Suspens',
	'Due Date'              : 'Date d\'Écheánce',
	'On Hold Date'          : 'Date Mise en Suspens',
	'Needed By'             : 'Date Limite',
	'Invoice Number'        : 'Numéro de Facture',
	'On Hold By'            : 'Mis en Suspens Par',
	'Days Pending'          : 'Jours en Attente',
	'Post Date'             : 'Post Date',
	'Priority'              : 'Priorité',
